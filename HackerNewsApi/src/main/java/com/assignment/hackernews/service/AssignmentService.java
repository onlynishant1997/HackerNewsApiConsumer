...
public class AssignmentService {
	...
	// Configurable Keeping it 240 to get response of last 4 hours, you can make it
	// 10 for getting top story of last 10 minutes
	 ...
	 * @return the list
	 */
	protected List<Story> extractStories(List<String> listOfStoryIds) {
	 ...
	 * @return the top ten stories in last ten minutes sorted by score
	 */
	protected List<Story> getTopTenStoriesInLastTenMinutesSortedByScore(List<Story> listOfTopStories) {
	 ...
	 * Creates A Callable task to fetch the Comments based on the
	 * storyId from the api and executes.
	 *
	 * @param storyId the story id
	 * @return the optional
	 ...
	 */
	protected String getTopStories() {
